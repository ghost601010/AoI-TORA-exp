...
% clear;
% clc;
function[alltask1,md_tau,tau,dealnum,tbl_num,d,T,t_remain]=es_1()
MD_num=25;%移动端用户数目 N设为5
MD_tau_num=5;%每个移动端用户总共产生的任务数 设为8
for a=1:1
    %1区域任务读取
    alltask1=xlsread('param','Sheet4','A2:I126');
    for b=1:MD_num
